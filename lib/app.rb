...
def first_tweet() # ligne qui permet de tweeter sur ton compte
client.update('Mon premier tweet en Ruby !!!!')
end

def follower()
client.follow("mahautlatinis")
end

def say_hello(journalists)
  journalists.sample(5).map{|journalist| login_twitter.update("Bonjour #{journalist}, Merci pour votre action #bonjour_monde")}
  #map will return a new modified array, whereas each will return the original array.
end
